                    ...
                    <div id="header" className="uk-modal-header uk-text-center">
                        ...
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <fieldset className="uk-fieldset">
                                ...
                                <label htmlFor="attending">Which days can you attend?<span className="required">*</span></label>
                                ...
                                <label htmlFor="terms">I acknowledge the following:<br/><br/>

                                    The information I provided above is accurate. By registering, I commit to attending the Summit. As such, the Departments of Engineering and Computer Science are <span className="uk-text-bold">reserving my seat</span> and are <span className="uk-text-bold">funding my participation</span>. I will immediately communicate any changes to the information provided to the event coordinators at <a href="mailto:ecs.summit@gmail.com">ecs.summit@gmail.com</a>.<span className="required">*</span>
                                </label>
                                <div className="uk-margin">
                                    <label><input className="uk-checkbox" name="terms" value="Approved" type="checkbox"/> I agree</label>
                                </div>
                                <div className="uk-margin">
