...
class VolunteerForm extends React.Component {
    ...
    handleSubmit(event) {  // handles form submit without any jquery
        ...
        */
        ...
        if (!data.email ||
        ...
        else if (!VolunteerForm.validEmail(data.email)) {   // if email is not valid show error
            document.getElementById('message_status').innerHTML = '<div id="invalid" class="uk-alert-danger" uk-alert="">Invalid Email</div>';
            document.getElementById("email").classList.add("uk-form-danger");
            return false;
        }
        else if (data.phone && !VolunteerForm.validPhone(data.phone)) {   // if email is not valid show error
            ...
            document.getElementById("times").classList.add("uk-form-success");
            ...
            xhr.onreadystatechange = function () {
                ...
                // language=HTML
                document.getElementById("header").innerHTML = "<h2 class='uk-modal-title'>Thank you for signing up to volunteer!</h2>";
                document.getElementById("body").innerHTML = "We have received your request and you should receive an " +
    ...
    render(){
        return (
            <div>
                <p className="uk-text-center">Click the button below if you're interested in volunteering:</p>
                <p className="uk-text-center"><a className="uk-button uk-button-large uk-button-secondary" href="#modal-center" uk-toggle="">Sign Up</a></p>
                <div id="modal-center" className="uk-flex-top" uk-modal="">
                    ...
                    <div id="header" className="uk-modal-header uk-text-center">
                        <h2 className="uk-modal-title">Volunteer Form</h2>
                        ...
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <fieldset className="uk-fieldset">
                                ...
                                <label htmlFor="attending">Which days can you help out?<span className="required">*</span></label>
                                ...
                                <div className="uk-margin">
                                    <label htmlFor="times">Any partial times? (Please list)</label>
                                    <input alt="times" className="uk-input" id="times" label="" required="" name="times" title="times"/>
                                </div>
